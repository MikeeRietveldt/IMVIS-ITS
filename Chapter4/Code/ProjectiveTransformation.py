...
sa = np.sin(np.deg2rad(a)) # sin anders werken vele getalen (vooral negatief) niet
R = np.array([[ca,-sa,0],[sa,ca,0], [0,0,1]]) # definieren van matrix
...
I2 = f_transformAffine(A, grayImage)
