# ITS IMVIS
# Chapter 4 - vraag 6 - Draai 45 graden en 200 px breeder
...
T = np.array([[ca,-sa,0],[sa,ca,200],[0,0,1]])  # je ziet dit verschuiven niet vanwege het normaliseren in de bounding box
