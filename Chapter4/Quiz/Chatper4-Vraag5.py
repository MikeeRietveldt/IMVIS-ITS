# ITS IMVIS
# Chapter 4 - Vraag 5 reflection y axis + openCV
...
# Transformatie y axis (vraag1)
#T = np.array([[1,0],[0,-1]]) # x y x y 
#I2 = f_transform(T, grayImage)

# Transformatie openCV
I2 = cv2.flip(grayImage, 1) # 0 voor x 1 voor y axis
