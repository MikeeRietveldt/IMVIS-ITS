# ITS IMVIS
# Chapter 4 - 180graden links && 90 graden rechts 
# Mike Rietveldt -- 20183380

# door sa met sin te doen ipv cos kun je alle kanten op draaien, de berekening is nu beter. (je kunt nu ook - getallen gebruiken voor de angle)
...
a = -90  # angle (180 voor andere antwoord)
ca = np.cos(np.deg2rad(a))
sa = np.sin(np.deg2rad(a)) # hierdoor kun je ook - doen, dit moet niet cos 
