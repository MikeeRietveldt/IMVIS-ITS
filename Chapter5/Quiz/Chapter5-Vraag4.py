# ITS IMVIS
# Chapter 5 - Vraag 4 - kopie van projective transformation/warp maken en op andere foto toepassen
...
TestFoto = cv2.imread(r'C:\Users\Mike\Desktop\ITS\Imvis\Chatpter2\Pics\AudiRS3.png',cv2.IMREAD_GRAYSCALE)  
...
P = f_getPoints(grayImage, 6)
P_dash = f_getPoints(ProjectiveWarpedImage, 6)
...
height, width = ProjectiveWarpedImage.shape[:2]

new_im = TestFoto
plt.imshow(new_im, cmap='gray')
I2 = cv2.warpPerspective(TestFoto, H, (width, height))
plt.imshow(I2, cmap='gray')
plt.show()
plt.imshow(ProjectiveWarpedImage, cmap='gray')
plt.show()