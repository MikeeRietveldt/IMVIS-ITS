...
P_dash = f_getPoints(ProjectiveWarpedImage, 3)
...
I2 = f_transformProjective(H, grayImage)
plt.subplot(121)
...
#bug aangezien we nooit de scale factor meenemen. Hierdoor is het resultaat niet helemaal juist